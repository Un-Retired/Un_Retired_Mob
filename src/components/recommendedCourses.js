...
export const recommendedCourses = [
  // 권문현
  {
    ...
    title: "47년 호텔경력",
    description:
      "웨스턴 조선 호텔, 권문현 지배인이 들려주는 호텔서비스의 모든 것.",
  ...
  // 이기훈
  {
    ...
    title: "25년 은퇴설계",
    description:
      "은퇴설계 25년 경력의 베테랑 이기훈 강사의 직장이 아닌 직업 만드는 법.",
  ...
  // 유니초이
  {
    ...
    title: "20년 에티켓 마스터",
    description:
      "우아한 매너로 빛나는 성공의 법칙: 20년 경력의 에티켓 마스터가 전하는 실천적 지혜.",
