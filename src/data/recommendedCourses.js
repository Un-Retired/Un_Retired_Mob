...
export const recommendedCourses = [
  ...
  // 김태연
  {
    ...
    introduction:
      "안녕하세요. 37년 이상의 유아교육 경력을 가진 전문가로 강남 서초 지역에서 14년간 영어 유치원을 운영하며 글로벌 교육 환경을 구축하고 놀이 교육을 통해 아이들이 행복하게 성장할 수 있도록 지원해왔습니다.  제 경험과 노하우를 바탕으로 교육의 질을 높이고 학부모님과 차세대 교육 전문가들에게 소중한 지식을 전수하겠습니다.",
    curriculum: [
      {
        episode: "Episode 1",
